...
public class MyExpeariance extends JPanel {
    @Override
    public void paint(Graphics g) {
        ...
        BufferedImage resizedImage = scaleOp.filter(image, null);

// Сохраняем уменьшенное изображение
        try {
            ImageIO.write(resizedImage, "png", new File("path/to/resizedImage.png"));
        } catch (IOException e) {
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Volkswagen exp");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frame.setSize(400, 450);
        frame.setLocationRelativeTo(null);
        frame.add(new MyExpeariance());
